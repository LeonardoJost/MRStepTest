...
modelFormula=@formula(RPE~relativeResistance*conditionContrasts+(relativeResistance*conditionContrasts|ID))
...
modelFormula=@formula(RPE~relativeResistance*conditionContrasts+zerocorr(relativeResistance*conditionContrasts|ID))
...
#conditionContrasts
modelFormula=@formula(RPE~relativeResistance+relativeResistance&conditionContrasts+(relativeResistance*conditionContrasts|ID))
@elapsed m12=fit(LinearMixedModel,modelFormula, dataset,REML=false)
#relativeResistance
modelFormula=@formula(RPE~relativeResistance&conditionContrasts+conditionContrasts+(relativeResistance*conditionContrasts|ID))
...
draw(PNG("figs/Residual Plots/hist3.png"),hist)
draw(PNG("figs/Residual Plots/resplot3.png"),resplot)
